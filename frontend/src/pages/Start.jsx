      ...
      <div className="relative w-[360px] h-[760px] rounded-[40px] overflow-hidden border border-white/10 bg-black shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-5">
          ...
          <div>
            ...
            <div className="mt-16">
              ...
              <p className="text-gray-300 mt-4 text-sm leading-6">
                Fast, affordable and secure rides.
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <Link to="/login">
              <button className="w-full mt-4 bg-white/10 backdrop-blur-lg border border-white/10 hover:bg-white/20 transition-all duration-300 py-4 rounded-2xl text-white font-semibold">
